...
public class SubChapterFragment extends Fragment implements RecyclerViewAdapterChapt.onChaptClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapterChapt(getContext(), db.allchapterdataM(1), this);
    ...
    public void onChaptClick(int position) {
        List<Chapters> items = db.allchapterdataM(1);
